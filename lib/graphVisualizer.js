...
var dotparser = __webpack_require__(1);
...
class GraphVisualizer {
    ...
    static ParseNodePosition(text){
        var pos = new Object();
        //SVG format are pixel positioning 
        var result = text.split(',');
        pos.X =  parseFloat(result[0]);
        //hack: parseFloat ignore all characters after valid float number, so 
    ...
    static ParseEdgePosition(text){
        ...
        for(var i = 0; i < positions.length; i++) {
            ...
            if (components[0] == 'e') {
                ...
                if (i == 2 && t == "directional" || i == 1 && t == "default") {
                    str += 'C ';
                }
    ...
    static ParseEdge(doc, edge) {
        ...
        GraphVisualizer.ParseTip(doc, data);
    }
